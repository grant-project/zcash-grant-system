enum proposalTypes {
  ...
  PROPOSAL_SUBSCRIBE_PENDING = 'PROPOSAL_SUBSCRIBE_PENDING',
  PROPOSAL_SUBSCRIBE_FULFILLED = 'PROPOSAL_SUBSCRIBE_FULFILLED',
  PROPOSAL_SUBSCRIBE_REJECTED = 'PROPOSAL_SUBSCRIBE_REJECTED',
}
